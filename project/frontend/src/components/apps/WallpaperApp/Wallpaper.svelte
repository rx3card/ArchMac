<script lang="ts">
	...
	import { wallpapers_config } from '$lib/configs/wallpapers/wallpaper.config.ts';
	import { smaller_closest_value } from '$lib/helpers/smaller-closest-value.ts';
	import { create_interval } from '$lib/state/interval.svelte.ts';
