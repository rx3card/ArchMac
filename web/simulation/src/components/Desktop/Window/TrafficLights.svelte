<script lang="ts">
	import CloseIcon from '$lib/components/SVG/traffic-lights/CloseSVG.svelte';
	import GreenLight from '$lib/components/SVG/traffic-lights/GreenLight.svelte';
	import MinimizeSvg from '$lib/components/SVG/traffic-lights/MinimizeSVG.svelte';
